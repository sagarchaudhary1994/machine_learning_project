    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            transformed_dir = os.path.join(
                data_transformation_artifact_dir, data_transformation_info[DATA_TRANSFORMATION_TRANSFORMED_DIR_KEY])
    ...
    def get_model_pusher_config(self) -> ModelPusherConfig:
        try:
            ...
            export_dir_path = os.path.join(
                artifact_dir, model_pusher_config[MODEL_PUSHER_MODEL_EXPORT_DIR_KEY], CURRENT_TIME_STAMP)
